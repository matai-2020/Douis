  ...
  return knex('restaurants').del()
    .then(function () {
      ...
      return knex('restaurants').insert([
        ...
        { id: 4, name: 'Little & Friday', rating: 4.1, lat: -36.8667617, long: 174.7741317, price_range: 'Average', image: 'little-and-friday-newmarket.png', type: 'Cafe', description: 'Have your mum been asking you to go out for the last 4 weeks, and need to make it up to her? Little & Friday will give you the perfect setting for a cuppa on a rainy saturday' },
